...
const INITIAL_PRODUCTS = [
  ...
  },
  {
    ...
    title: 'Box 4 Rosas Azules',
    category: 'combos',
    categories: ["combos","rosas"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 80.00',
    tag: '4 Rosas Azules',
    image: '/images/products/box-4-rosas-azules.webp',
    imageFallback: '/images/products/box-4-rosas-azules.jpg',
    description: 'Box sombrerero blanco con 4 rosas azules importadas y margaritas blancas frescas.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000059',
    title: 'Box 6 Tulipanes con Lirios',
    category: 'combos',
    categories: ["combos","tulipanes","pastel"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 220.00',
    tag: '6 Tulipanes + Lirios',
    image: '/images/products/box-6-tulipanes-con-lirios.webp',
    imageFallback: '/images/products/box-6-tulipanes-con-lirios.jpg',
    description: 'Box sombrerero negro personalizado con 6 tulipanes multicolores, 2 lirios orientales y astromelias.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000060',
    title: 'Box 7 Girasoles',
    category: 'combos',
    categories: ["combos","buchones"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 95.00',
    tag: '7 Girasoles',
    image: '/images/products/box-7-girasoles.webp',
    imageFallback: '/images/products/box-7-girasoles.jpg',
    description: 'Box cilíndrico negro con 7 girasoles frescos y follaje verde de autor.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000061',
    title: 'Box Perlas 30 Rosas',
    category: 'combos',
    categories: ["combos","rosas","buchones"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 250.00',
    tag: '30 Rosas Perlas',
    image: '/images/products/box-perlas-30-rosas.webp',
    imageFallback: '/images/products/box-perlas-30-rosas.jpg',
    description: 'Box sombrerero blanco con asa de perlas y 30 rosas rojas seleccionadas.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000062',
    title: 'Box Cartera Girasol',
    category: 'combos',
    categories: ["combos","buchones"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 65.00',
    tag: 'Cartera Girasol',
    image: '/images/products/box-cartera-girasol.webp',
    imageFallback: '/images/products/box-cartera-girasol.jpg',
    description: 'Cartera box kraft con asas, 1 girasol central, margaritas amarillas y solidago.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000063',
    title: 'Ramo 8 Rosas Bicolor',
    category: 'rosas',
    categories: ["rosas"],
    categoryName: 'Rosas Premium',
    price: 'S/ 75.00',
    tag: '8 Rosas Bicolor',
    image: '/images/products/ramo-8-rosas-bicolor.webp',
    imageFallback: '/images/products/ramo-8-rosas-bicolor.jpg',
    description: 'Ramo de 8 rosas bicolor (azul y rojo) con nube de gypsophila y cinta satinada.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000064',
    title: 'Box Lirio + Claveles con Globo',
    category: 'combos',
    categories: ["combos","pastel"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 75.00',
    tag: 'Lirio & Claveles',
    image: '/images/products/box-lirio-claveles-globo.webp',
    imageFallback: '/images/products/box-lirio-claveles-globo.jpg',
    description: 'Box sombrerero blanco con lirio oriental, claveles rosados y globo metálico de estrella.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000065',
    title: 'Box Cartera 6 Rosas Rojas',
    category: 'combos',
    categories: ["combos","rosas"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 75.00',
    tag: 'Cartera 6 Rosas',
    image: '/images/products/box-cartera-6-rosas-rojas.webp',
    imageFallback: '/images/products/box-cartera-6-rosas-rojas.jpg',
    description: 'Cartera box negra con asas, 6 rosas rojas seleccionadas y margaritas blancas.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000066',
    title: 'Ramo 8 Rosas más 1 Lirio',
    category: 'rosas',
    categories: ["rosas","pastel"],
    categoryName: 'Rosas Premium',
    price: 'S/ 90.00',
    tag: '8 Rosas + 1 Lirio',
    image: '/images/products/ramo-8-rosas-mas-1-lirio.webp',
    imageFallback: '/images/products/ramo-8-rosas-mas-1-lirio.jpg',
    description: 'Ramo de 8 rosas rojas con 1 lirio aromático en papel kraft y cinta Rouss.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000067',
    title: 'Box Perlas 9 Rosas Bicolor',
    category: 'combos',
    categories: ["combos","rosas"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 95.00',
    tag: '9 Rosas Bicolor',
    image: '/images/products/box-perlas-9-rosas-bicolor.webp',
    imageFallback: '/images/products/box-perlas-9-rosas-bicolor.jpg',
    description: 'Box cuadrado negro con asa de perlas y 9 rosas bicolores en tono peach/coral.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000068',
    title: 'Canasta Girasoles & Rosas con Peluche',
    category: 'combos',
    categories: ["combos","buchones"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 180.00',
    tag: 'Combo Peluche 🧸',
    image: '/images/products/canasta-girasoles-rosas-peluche.webp',
    imageFallback: '/images/products/canasta-girasoles-rosas-peluche.jpg',
    description: 'Canasta artesanal de mimbre con tierno peluche, girasoles y rosas en tono salmón.'
  },
  {
    id: 'ba000001-0000-4000-a000-000000000069',
    title: 'Box de Lujo Rosas, Tulipanes & Ferrero',
    category: 'combos',
    categories: ["combos","tulipanes","rosas"],
    categoryName: 'Detalles & Combos Especiales',
    price: 'S/ 300.00',
    tag: 'Lujo Ferrero 🍫',
    image: '/images/products/box-lujo-rosas-tulipanes-ferrero.webp',
    imageFallback: '/images/products/box-lujo-rosas-tulipanes-ferrero.jpg',
    description: 'Box de lujo con gaveta de 8 chocolates Ferrero Rocher, 12 rosas rojas y 2 tulipanes rosados.'
  }
];
